...
UPLOAD_FOLDER = r'C:\adverts\images'
...
# Route to create an advert (No authentication required)
...
# Route to update an advert (No authentication required)
...
# Route to delete an advert (No authentication required)
